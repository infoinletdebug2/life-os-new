    ...
    <div className="space-y-6">
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-white">Base Pricing</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-white">Weekly Rate Multipliers</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold text-white">Seasonal Rates</h3>
          </div>
          <Button
            type="button"
            variant="outline"
        ...
        {formData.seasonalRates.length === 0 ? (
          ...
          <div className="space-y-3">
            {formData.seasonalRates.map(rate => (
              <div key={rate.id} className="grid grid-cols-1 md:grid-cols-5 gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold text-white">Special Date Rates</h3>
          </div>
          <Button
            type="button"
            variant="outline"
        ...
        {formData.specialRates.length === 0 ? (
          ...
          <div className="space-y-3">
            {formData.specialRates.map(rate => (
              <div key={rate.id} className="grid grid-cols-1 md:grid-cols-4 gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
                <div className="space-y-1">
      ...
      <div className="fixed inset-0 bg-black/80 backdrop-blur-lg z-50 flex items-center justify-center p-4">
        ...
        >
          <div className="bg-gradient-to-br from-gray-900/98 to-gray-800/98 backdrop-blur-2xl border border-white/30 rounded-3xl shadow-2xl shadow-black/50 flex flex-col h-full overflow-hidden">
            ...
            {/* Progress Steps */}
            <div className="px-8 py-6 border-b border-white/10 bg-gradient-to-r from-gray-800/40 to-gray-700/40">
              ...
              <div className="flex items-center gap-4">
                {currentStep > 1 && (
                  <Button
                    ...
                    className="border-2 border-gray-500/50 text-gray-300 hover:text-white hover:border-gray-400 px-6 py-3 rounded-xl transition-all duration-200 hover:scale-105"
                  >
                    Previous
                  </Button>
                )}
                ...
                {currentStep < 2 ? (
                  <Button
                    ...
                    className="gap-3 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold px-8 py-3 rounded-xl shadow-lg shadow-cyan-500/25 transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                  >
                    Next Step
                    <motion.div
                      animate={{ x: [0, 4, 0] }}
                  ...
                  <Button
                    ...
                    className="gap-3 bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white font-semibold px-8 py-3 rounded-xl shadow-lg shadow-emerald-500/25 transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                  >
