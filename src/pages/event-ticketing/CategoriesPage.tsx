...
export default function CategoriesPage() {
  return (
    <DashboardLayout currentView="categories" selectedCategory="travel">
      <div className="flex flex-col h-full">
        {/* Header */}
        <div className="glass backdrop-blur-xl border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Event Categories</h1>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Organize events by categories and types
              </p>
            </div>
            <Link
              to="/travel/event-ticketing/categories/create"
