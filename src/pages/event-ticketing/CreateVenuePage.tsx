...
import CreateVenueForm from '../../components/event-ticketing/CreateVenueForm';
...
export default function CreateVenuePage() {
  ...
  const handleClose = () => {
    navigate('/travel/event-ticketing/venues');
  };

  const handleSave = (venue: any) => {
  ...
  return (
    <DashboardLayout currentView="create-venue" selectedCategory="travel">
        ...
        <div className="glass backdrop-blur-xl border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create Venue</h1>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="max-w-4xl mx-auto">
            <div className="glass backdrop-blur-xl rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
              <CreateVenueForm onSave={handleSave} />
            </div>
          </div>
        </div>
      </div>
