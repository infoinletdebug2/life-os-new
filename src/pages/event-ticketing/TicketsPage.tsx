...
export default function TicketsPage() {
  return (
    <DashboardLayout currentView="tickets" selectedCategory="travel">
      <div className="flex flex-col h-full">
        {/* Header */}
        <div className="glass backdrop-blur-xl border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Event Tickets</h1>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Manage ticket types and pricing for events
              </p>
            </div>
            <Link
              to="/travel/event-ticketing/tickets/create"
