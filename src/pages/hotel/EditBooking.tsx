      ...
      <div className="p-8 space-y-8 max-w-6xl mx-auto">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Modify booking details and information</p>
          </div>
        </div>
        ...
        <div className="bg-secondary backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-center">
          ...
          <h3 className="text-xl font-bold text-foreground mb-2">Edit Booking Form</h3>
